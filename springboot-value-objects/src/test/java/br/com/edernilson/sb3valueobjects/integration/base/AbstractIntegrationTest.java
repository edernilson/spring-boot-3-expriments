package br.com.edernilson.sb3valueobjects.integration.base;
...
public abstract class AbstractIntegrationTest extends PersonTestFactory {
    ...
    protected <T> T performPostRequestExpectedNotFoundError(String path, Object object, Class<T> responseType)
            throws Exception {
        return performPostRequest(path, object, responseType, status().isNotFound());
    }

    protected <T> T performPostRequestExpectedBadRequestError(String path, Object object, Class<T> responseType)
            throws Exception {
        return performPostRequest(path, object, responseType, status().isBadRequest());
    }
